...
void init(void)
{
    //calulate number of spaces
    int total = d * d;
	
    // add the titles to the board
    for (int i = 0; i < d; i++)
    {
        for (int j = 0; j < d; j++)
        // set value
...
bool move(int tile)
{
    ...
    //Search for the row and column of number
    int row = 0, column = 0;
    ...
    // Check spaces around to see if its a legal move
